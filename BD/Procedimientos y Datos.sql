...
-- Tiempo de generación: 07-07-2023 a las 19:07:27
...
CREATE DEFINER=`root`@`localhost` FUNCTION `editarOrden` (`_idCompra` VARCHAR(255), `_idUsuario` VARCHAR(255), `_idProducto` VARCHAR(255), `_detalle` VARCHAR(255), `_montoTotal` INT(11)) RETURNS INT(1)  begin
    declare _cant int;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `editarPersona` (`_idPersona` VARCHAR(15), `_nombre` VARCHAR(30), `_apellido1` VARCHAR(15), `_apellido2` VARCHAR(15), `_telefono` VARCHAR(9), `_celular` VARCHAR(9), `_direccion` VARCHAR(255), `_correo` VARCHAR(100), `_idRol` VARCHAR(100)) RETURNS INT(1)  begin
    declare _cant int;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `editarProducto` (`_idProducto` VARCHAR(255), `_nombreProducto` VARCHAR(255), `_color` VARCHAR(255), `_precio` INT, `_talla` INT, `_stock` INT, `_genero` VARCHAR(75)) RETURNS INT(1)  begin
    declare _cant int;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `modificarToken` (`_idUsuario` VARCHAR(15), `_tkR` VARCHAR(255)) RETURNS INT(1)  begin
    declare _cant int;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `nuevaOrden` (`_idCompra` VARCHAR(255), `_idUsuario` VARCHAR(255), `_idProducto` VARCHAR(255), `_detalle` VARCHAR(255), `_montoTotal` INT(11), `_fechaCreacion` DATE, `_idFactura` INT) RETURNS INT(1)  begin
    declare _cant int;
    select count(idCompra) into _cant from ordenesdecompras where idCompra = _idCompra;
    if _cant < 1 then
...
CREATE DEFINER=`root`@`localhost` FUNCTION `nuevoOrden` (`_idCompra` VARCHAR(255), `_idUsuario` VARCHAR(255), `_idProducto` VARCHAR(255), `_detalle` VARCHAR(255), `_montoTotal` INT(11), `_fechaCreacion` DATE, `_idFactura` INT) RETURNS INT(1)  begin
    declare _cant int;
    select count(idCompra) into _cant from ordenesdecompras where idCompra = _idCompra;
    if _cant < 1 then
        SELECT stock FROM productos WHERE idProducto = _idProducto INTO @stock;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `nuevoPersona` (`_idPersona` VARCHAR(15), `_nombre` VARCHAR(30), `_apellido1` VARCHAR(15), `_apellido2` VARCHAR(15), `_telefono` VARCHAR(9), `_celular` VARCHAR(9), `_direccion` VARCHAR(255), `_correo` VARCHAR(100), `_idRol` VARCHAR(250)) RETURNS INT(1)  begin 
    declare _cant int;
    select count(_idPersona) into _cant from Personas where idPersona = _idPersona;
    if _cant < 1 then
        insert into personas(idPersona, nombre, apellido1, apellido2, telefono, 
...
CREATE DEFINER=`root`@`localhost` FUNCTION `nuevoProducto` (`_idProducto` VARCHAR(255), `_nombreProducto` VARCHAR(255), `_color` VARCHAR(255), `_precio` INT, `_Talla` VARCHAR(15), `_stock` INT, `_genero` VARCHAR(255)) RETURNS INT(1)  begin
    declare _cant int;
    select count(idProducto) into _cant from productos where idProducto = _idProducto;
    if _cant < 1 then
...
CREATE DEFINER=`root`@`localhost` FUNCTION `nuevoUsuario` (`_idUsuario` VARCHAR(15), `_idRol` INT, `_passw` VARCHAR(255)) RETURNS INT(1)  begin
    declare _cant int;
...
CREATE DEFINER=`root`@`localhost` FUNCTION `passwUsuario` (`_idUsuario` VARCHAR(255), `_passw` VARCHAR(255)) RETURNS INT(1)  begin
    declare _cant int;
    select count(idUsuario) into _cant from usuario where idUsuario = _idUsuario;
    if _cant > 0 then
        update usuario set
...
CREATE DEFINER=`root`@`localhost` FUNCTION `rolUsuario` (`_idUsuario` INT, `_idRol` INT) RETURNS INT(1)  begin
    declare _cant int;
    select count(idUsuario) into _cant from usuario where idUsuario = _idUsuario;
    if _cant > 0 then
        update usuario set
